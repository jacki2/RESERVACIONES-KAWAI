    ...
    <div class="container py-4">
        <div class="card shadow">
            <div class="card-header bg-primary text-white">
                <h3 class="mb-0"><i class="fas fa-calendar-plus me-2"></i>Agregar Nueva Reserva</h3>
            </div>
            <div class="card-body">
                <form action="guardar_reserva.php" method="POST" id="reservaForm" class="needs-validation" novalidate>
