...
<head>
    ...
    <title><?= $exito ? 'Reserva Actualizada' : 'Error' ?></title>
    <!-- Bootstrap CSS -->
        ...
        <div class="card shadow mx-auto" style="max-width: 500px;">
            <div class="card-body text-center p-5">
                <?php if ($exito): ?>
                    ...
                    <h2 class="mb-4">¡Reserva Actualizada con Éxito!</h2>
                    <p class="mb-4">La reserva #<?= $id_reserva ?> ha sido actualizada correctamente.</p>
                <?php else: ?>
                    <div class="mb-4">
                        <i class="fas fa-times-circle text-danger" style="font-size: 4rem;"></i>
                    </div>
                    <h2 class="mb-4">Error al Actualizar la Reserva</h2>
